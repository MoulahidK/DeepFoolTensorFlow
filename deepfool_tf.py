...
# model = 'Conv2D_3_Layers.h5'
model = 'Gaussian_3_Layers.h5'

def deepfool(image, model, num_classes=3, overshoot=0.02, max_iter=50, shape=(224, 224, 3)):
    ...
    while k_i == label and loop_i < max_iter:
        ...
        # error = (tf.norm(r_tot.flatten())) / (tf.norm(image_norm.flatten()))
        loop_i += 1

    r_tot = (1 + overshoot) * r_tot
    # adversarial_robustness = (1 / 300) * error
